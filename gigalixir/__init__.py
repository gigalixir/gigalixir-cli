...
@click.pass_context
@report_errors
def upgrade(ctx, card_number, card_exp_month, card_exp_year, card_cvc):
    """
    Upgrade from free tier to standard tier.
    """
    gigalixir_user.upgrade(ctx.obj['host'], card_number, card_exp_month, card_exp_year, card_cvc)
