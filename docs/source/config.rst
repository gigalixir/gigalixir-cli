.. meta::
   :http-equiv=Refresh: 0; url='https://www.gigalixir.com/docs/config'
...
Gigalixir supports static outgoing ip addresses for customers using QuotaGuard Static IP's - (https://www.quotaguard.com) - which are affordable and simple. Just configure your http client to make requests through the proxy. For example, with HTTPoison, something like this
