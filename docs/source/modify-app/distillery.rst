...
:bash:`gigalixir-buildpack-phoenix-static` is optional if you do not have Phoenix static assets. For more information about buildpacks, see :ref:`life of a deploy`.
...
- If the last buildpack is :bash:`gigalixir-buildpack-phoenix-static`, then the command run will be :bash:`mix phx.server`.
